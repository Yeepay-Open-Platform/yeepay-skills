...
| 下单/小程序/APP/H5/主扫/被扫/收银台/银行转账/查单 | `references/产品能力/收单/`                      | `acquiring`      |
...
| 氢钱包/记账簿/预收款/B2B 买家专属收款账号/来账通知/记账簿支付 | `references/产品能力/氢钱包/氢钱包（记账簿）.md`       | `hydrogen-wallet` |
| 放款/联合贷/信用卡还款/协议支付/代扣/签约绑卡/批量支付 | `references/产品能力/金融/`                              | `financial`      |
